...
const Login = () => {
  ...
  const login = useCallback(async()=>{
    try {
        ...
        await localStorage.setItem("userId_token", loginResponse.data.token)
        navigate("/dashboard");
    } catch(error){
  ...
  return (
    ...
    <div className='bg-whiteSmoke w-[400px] h-[385px] rounded-xl shadow-lg shadow-gray-600 p-5'>
        <div className='flex flex-col items-center gap-2 p-2'>
            <h1 className='text-4xl font-bold text-sky-950'>Log In</h1>
            <p className='text-lg text-center text-slate-700 text-pretty'>Enter your information to log in</p>
        </div>
        ...
        <div className='flex flex-col items-center m-2 mt-6 relative gap-2'>
            <button 
            ...
            >
                ...
                <span className="relative text-slate-100">Login</span>
            </button>
            <p className='absolute top-12 text-slate-800'>
